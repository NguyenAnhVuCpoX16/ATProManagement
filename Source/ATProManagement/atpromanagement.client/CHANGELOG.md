...
- Create Angular project with ng: `ng new atpromanagement.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`atpromanagement.client.esproj`).
